...
|No|時期|業務|経験|環境|役割|
----|----|----|----|----|---- 
|03|2015年3月<BR>〜<BR>2019年6月<BR>（4年4ヶ月）|・企画<BR>・運営|・AWS移行<BR>・AWSデザイン<BR>・AWSオペレーション<BR>・チームビルディング（〜5名）<BR>・運営（契約,課金収支,ガイドライン整備）<BR>・技術トレーニング支援|・[Cloud](PlantUML/001_aws.png)<BR>・[OS,AP,DB]<BR>・[Middleware]|リーダー|
