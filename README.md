...
|03|2015年3月<BR>〜<BR>2019年6月<BR>（4年4ヶ月）|・企画<BR>・運営|・AWS移行<BR>・AWSデザイン<BR>・AWSオペレーション<BR>・チームビルディング（〜5名）・運営（契約,課金収支,ガイドライン整備）<BR>・技術トレーニング支援|・VPC/EC2/S3等<BR>・Win/RHEL<BR>・RDS（Oracle/Aurora Postgres）<BR>・Apache/Tomcat<BR>・Jenkins<BR>・Trac/SVN<BR>・JP1/AJS|ベンダー/リーダー|
