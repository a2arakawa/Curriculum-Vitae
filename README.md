...
|02|2011年12月<BR>〜<BR>2015年2月<BR>（3年3ヶ月）|・センター移行<BR>・情シス|・ECサイト基盤維持保守<BR>・データセンター移行計画立案/推進<BR>・プロジェクト管理<BR>（〜10名,予算管理,工数管理,ベンダー協業）|・物理サーバ<BR>・クラウド<BR>・[OS,AP,DB]<BR>・[Middleware]<BR>・VDI|マネージャ|
|01|2002年4月<BR>〜<BR>2011年11月<BR>（9年8ヶ月）|・サーバ設計構築<BR>・サーバ維持保守|・WebDBシステム設計構築<BR>・ストレージ移行<BR>・メインフレーム連携<BR>・プロジェクト管理<BR>（〜５名,工数管理,ベンダー協業）|・物理サーバ<BR>・Hitachi-USPV<BR>・[OS,AP,DB]<BR>・[Middleware]|メンバー<BR>〜<BR>リーダー|
